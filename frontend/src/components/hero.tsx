    ...
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-4 bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
            SpeaklyAI
          </h1>
        </motion.div>
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-7xl">
          <svg className="w-full h-auto opacity-20" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg">
            <defs>
